...
A playful, single-page to-do app where tasks float as colorful bubbles on a dark glassmorphic canvas. No build tools, no frameworks, no backend — just open `index.html` in a browser.
